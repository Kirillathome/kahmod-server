...
public interface CustomEquipmentAssets {
    ResourceKey<? extends Registry<EquipmentAsset>> ROOT_ID = ResourceKey.createRegistryKey(Kahmod.identifierOf("equipment_asset"));
    ...
    static ResourceKey<EquipmentAsset> createId(final String name) {
        return ResourceKey.create(ROOT_ID, Kahmod.identifierOf(name));
    }
}
